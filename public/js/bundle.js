...
})(
  {
          ...
          return new Promise(function (l, d) {
            ...
            if (
              (m.open(
                ...
                o(T, u.params, u.paramsSerializer),
                !0
              ),
              (m.timeout = u.timeout),
              'onloadend' in m
              ...
              (m.onabort = function () {
                m &&
                  (d(i('Request aborted', u, 'ECONNABORTED', m)), (m = null));
              }),
              (m.onerror = function () {
              ...
              var g =
                (u.withCredentials || a(T)) && u.xsrfCookieName
          ...
          return (
            ...
            (n.adapter || t.adapter)(n).then(
              function (e) {
                return (
                  s(n),
                  (e.data = r.call(n, e.data, e.headers, n.transformResponse)),
                  e
                );
              },
              function (e) {
    ...
    lMdc: [
      function (require, module, exports) {
        ...
        function t(r, n) {
          for (
            var e = n ? n.split('.') : o, t = r.split('.'), i = 0;
            i < 3;
            i++
          ) {
            if (e[i] > t[i]) return !0;
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (0, t.default)({
                            method: 'POST',
                            url: 'https://natours-sampath.vercel.app/api/v1/users/signup',
                            data: {
                              name: n,
                              email: i,
                              password: a,
    ...
    g63L: [
      function (require, module, exports) {
        ...
        var a = (exports.displayMap = function (a) {
          ...
          a.forEach(function (a) {
            ...
            (t.className = 'marker'),
              ...
              new mapboxgl.Popup({ offset: 30 })
                .setLngLat(a.coordinates)
                .setHTML(
                  '<p>Day '.concat(a.day, ': ').concat(a.description, '</p>')
                )
                .addTo(e),
              o.extend(a.coordinates);
          }),
            e.fitBounds(o, {
    ...
    FxPS: [
      function (require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.updateSetttings = void 0);
        var t = e(require('axios')),
          r = require('./alerts');
        function e(t) {
          return t && t.__esModule ? t : { default: t };
        ...
        var c = (exports.updateSetttings = (function () {
          var e = a(
            o().mark(function e(n, i) {
              var a;
              return o().wrap(
    ...
    Uj2q: [
      function (require, module, exports) {
        ...
        function o() {
          ...
          function h(t, r, e, n) {
            var o = r && r.prototype instanceof w ? r : w,
              i = Object.create(o.prototype),
              c = new G(n || []);
            return a(i, '_invoke', { value: j(t, e, c) }), i;
          }
          function p(t, r, e) {
            try {
              return { type: 'normal', arg: t.call(r, e) };
        ...
        var c = (exports.bookTour = (function () {
          var e = a(
            o().mark(function e(n) {
              var i, a;
              return o().wrap(
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (e.next = 4),
                          (0, t.default)(
                            'https://natours-sampath.vercel.app/api/v1/bookings/checkout-session/'.concat(
                              n
                            )
                          )
                        );
    ...
    Focm: [
      function (require, module, exports) {
        ...
        function u() {
          ...
          function m(e, r, t, s) {
            var n = r && r.prototype instanceof q ? r : q,
              u = Object.create(n.prototype),
              i = new P(s || []);
            return o(u, '_invoke', { value: I(e, t, i) }), u;
          }
          function j(e, r, t) {
            try {
            ...
            return function (n, u) {
              ...
              for (s.method = n, s.arg = u; ; ) {
                ...
                if ('next' === s.method) s.sent = s._sent = s.arg;
                  ...
                  if (o === f) throw ((o = h), s.arg);
                  s.dispatchException(s.arg);
                } else 'return' === s.method && s.abrupt('return', s.arg);
                o = y;
                var a = j(r, t, s);
                if ('normal' === a.type) {
                  if (((o = s.done ? h : p), a.arg === g)) continue;
                  return { value: a.arg, done: s.done };
                }
                'throw' === a.type &&
                  ((o = h), (s.method = 'throw'), (s.arg = a.arg));
              }
            };
          }
          function B(r, t) {
        ...
        var a = document.getElementById('map'),
          ...
          j = document.querySelector('.form-user-data'),
          f = document.querySelector('.form-user-settings'),
        ...
        if (
          ...
          l &&
            l.addEventListener('submit', function (r) {
              r.preventDefault();
          ...
          var y = JSON.parse(document.getElementById('map').dataset.location);
          (0, t.displayMap)(y);
        }
